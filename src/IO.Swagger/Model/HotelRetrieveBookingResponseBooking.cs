...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class HotelRetrieveBookingResponseBooking :  IEquatable<HotelRetrieveBookingResponseBooking>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HotelRetrieveBookingResponseBooking" /> class.
        /// </summary>
        ...
        public HotelRetrieveBookingResponseBooking(string reference = default(string), StatusEnum? status = default(StatusEnum?), DateTime? bookingDate = default(DateTime?), DateTime? comments = default(DateTime?), int? totalPrice = default(int?), string currency = default(string), DateTime? checkIn = default(DateTime?), DateTime? checkOut = default(DateTime?), HotelConfirmationRequestHolder holder = default(HotelConfirmationRequestHolder), HotelCancellationResponseBookingHotel hotel = default(HotelCancellationResponseBookingHotel))
        {
        ...
        {
            return this.Equals(input as HotelRetrieveBookingResponseBooking);
        }

        /// <summary>
        /// Returns true if HotelRetrieveBookingResponseBooking instances are equal
        /// </summary>
        /// <param name="input">Instance of HotelRetrieveBookingResponseBooking to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HotelRetrieveBookingResponseBooking input)
        {
            if (input == null)
                return false;
