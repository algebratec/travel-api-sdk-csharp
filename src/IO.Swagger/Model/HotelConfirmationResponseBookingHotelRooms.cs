...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class HotelConfirmationResponseBookingHotelRooms :  IEquatable<HotelConfirmationResponseBookingHotelRooms>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HotelConfirmationResponseBookingHotelRooms" /> class.
        /// </summary>
        ...
        public HotelConfirmationResponseBookingHotelRooms(string code = default(string), string name = default(string), string rateKey = default(string), string boardName = default(string), string boardCode = default(string), int? price = default(int?), int? adults = default(int?), int? children = default(int?), List<CancellationPolicy> cancellationPolicies = default(List<CancellationPolicy>), List<HotelConfirmationResponseBookingHotelPaxes> paxes = default(List<HotelConfirmationResponseBookingHotelPaxes>), List<HotelConfirmationResponseBookingHotelExtras> extras = default(List<HotelConfirmationResponseBookingHotelExtras>))
        {
            this.Code = code;
            this.Name = name;
        ...
        {
            return this.Equals(input as HotelConfirmationResponseBookingHotelRooms);
        }

        /// <summary>
        /// Returns true if HotelConfirmationResponseBookingHotelRooms instances are equal
        /// </summary>
        /// <param name="input">Instance of HotelConfirmationResponseBookingHotelRooms to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HotelConfirmationResponseBookingHotelRooms input)
        {
            if (input == null)
                return false;
