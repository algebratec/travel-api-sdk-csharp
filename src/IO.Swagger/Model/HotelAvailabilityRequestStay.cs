...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class HotelAvailabilityRequestStay :  IEquatable<HotelAvailabilityRequestStay>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HotelAvailabilityRequestStay" /> class.
        /// </summary>
        /// <param name="checkIn">checkIn.</param>
        /// <param name="checkOut">checkOut.</param>
        public HotelAvailabilityRequestStay(DateTime? checkIn = default(DateTime?), DateTime? checkOut = default(DateTime?))
        {
        ...
        {
            return this.Equals(input as HotelAvailabilityRequestStay);
        }

        /// <summary>
        /// Returns true if HotelAvailabilityRequestStay instances are equal
        /// </summary>
        /// <param name="input">Instance of HotelAvailabilityRequestStay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HotelAvailabilityRequestStay input)
        {
            if (input == null)
                return false;
