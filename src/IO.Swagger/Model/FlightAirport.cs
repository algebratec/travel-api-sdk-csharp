...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FlightAirport :  IEquatable<FlightAirport>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlightAirport" /> class.
        /// </summary>
        ...
        public FlightAirport(string cityCode = default(string), string cityName = default(string), string countryCode = default(string), string countryName = default(string), string display = default(string), string iata = default(string), string name = default(string), int? numberOfAirportsInTheCity = default(int?))
        {
        ...
        {
            return this.Equals(input as FlightAirport);
        }

        /// <summary>
        /// Returns true if FlightAirport instances are equal
        /// </summary>
        /// <param name="input">Instance of FlightAirport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlightAirport input)
        {
            if (input == null)
                return false;
